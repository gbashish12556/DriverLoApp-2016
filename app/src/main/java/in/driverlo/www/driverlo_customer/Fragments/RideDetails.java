...
import in.driverlo.www.driverlo_customer.DialogFragment.RatingDialog;
...
public class RideDetails extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(getActivity() != null) {
            if ((getActivity().getIntent() != null) && (getActivity().getIntent().getExtras() != null)) {
                ...
                brn_no = Helper.getValueFromBundle(bundle, Constants.Keys.BRN_NO);
            ...
            sendVolleyRequest(booking_status_url, Helper.checkParams(hashMap),"ride_detail");
            ...
            cancel_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    sendVolleyRequest(cancel_order_url,Helper.checkParams(hashMap),"cancel_order");
                }
            });
        }
    }
                    ...
                    if (errFlag.equals("0")) {
                        if (jsonObject.has("likes")) {
                            ...
                            while (count < jsonArray.length()) {
                                ...
                                booking_datetime.setText(Helper.getDisplayDate(JO.getString("booking_datetime")));
                                estimated_time.setText(JO.getString("estimated_time"));
                                vehicle_type.setText(Helper.getUpperCase(JO.getString("vehicle_type"))+" - "+Helper.getUpperCase(JO.getString("vehicle_mode")));
    ...
    public void OrderCancelSuccess(String response){
        if(getActivity() != null) {
            if (!Helper.CheckJsonError(response)) {

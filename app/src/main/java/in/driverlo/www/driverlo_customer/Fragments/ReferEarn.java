...
import in.driverlo.www.driverlo_customer.DialogFragment.ApplyReferalCode;
...
public class ReferEarn extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(getActivity() != null) {
            referral_code.setText(Helper.getPreference(getActivity(), Constants.Keys.REFERAL_CODE));
            start_inviting.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String referal_code = Helper.getPreference(getActivity(), Constants.Keys.REFERAL_CODE);
            ...
            sendVolleyRequest(get_point_url,Helper.checkParams(hashMap));
        }
    }

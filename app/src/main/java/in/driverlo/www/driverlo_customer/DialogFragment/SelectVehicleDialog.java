...
import in.driverlo.www.driverlo_customer.DialogFragment.EstimatedDayDialog;
import in.driverlo.www.driverlo_customer.DialogFragment.EstimatedTimeDialog;
        ...
        if(getActivity() != null) {
            ...
            next_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Helper.putPreference(getActivity(), Constants.Keys.SELECTED_VEHICLE_TYPE, vehicle_type_list[vehicle_type]);
                    Helper.putPreference(getActivity(), Constants.Keys.SELECTED_VEHICLE_MODE, vehicle_mode_list[vehicle_mode]);
                    String journey_type = Helper.getPreference(getActivity(),Constants.Keys.JOURNEY_TYPE);

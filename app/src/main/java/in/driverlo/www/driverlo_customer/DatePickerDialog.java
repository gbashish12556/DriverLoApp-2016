            ...
            next_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if ((datetime >= currentTime) && (datetime > 0)) {
                        ...
                        Fn.SystemPrintLn(Fn.getPreference(getActivity(), Constants.Keys.LATER_BOOKING_DATETIME));
                        if(Fn.isTimeNight(Fn.getPreference(getActivity(), Constants.Keys.LATER_BOOKING_DATETIME), 0, 0)){

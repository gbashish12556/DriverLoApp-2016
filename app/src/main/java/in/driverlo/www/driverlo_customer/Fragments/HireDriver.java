...
import in.driverlo.www.driverlo_customer.DialogFragment.DatePickerDialog;
import in.driverlo.www.driverlo_customer.Helper;
import in.driverlo.www.driverlo_customer.R;
import in.driverlo.www.driverlo_customer.Services.FetchAddressIntentService;
import in.driverlo.www.driverlo_customer.Utils.AppUtils;
...
public class HireDriver extends Fragment implements  View.OnClickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
            ...
            imageMarker.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isValid(pickup_address, dropoff_address)) {
                        ...
                        Helper.putPreference(getActivity(), Constants.Keys.PICKUP_ADDRESS, pickup_address);
                        Helper.putPreference(getActivity(), Constants.Keys.DROPOFF_ADDRESS, dropoff_address);
                        Helper.putPreference(getActivity(), Constants.Keys.JOURNEY_TYPE , journey_type_list[journey_type]);
                ...
                pickup_container.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick (View v){
                    try {
                        Helper.SystemPrintLn("pickup_location clicked");
                ...
                dropoff_container.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick (View v){
                    try {
                        Helper.SystemPrintLn("dropoff_location clicked");
                        Intent intent = new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_OVERLAY)
                                .setBoundsBias(new LatLngBounds(southwest, northeast))
                                .setFilter(typeFilter)
                                .build(getActivity());
    ...
    public void LoadAddress(){
        ...
        if(CompleteActivity.mGoogleApiClient.isConnected()) {
            Location mLastLocation = LocationServices.FusedLocationApi.getLastLocation(CompleteActivity.mGoogleApiClient);
            if (mLastLocation != null) {
                changeMap(mLastLocation);
            } else
                try {
                    LocationServices.FusedLocationApi.removeLocationUpdates(CompleteActivity.mGoogleApiClient, this);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            try {
                ...
                LocationServices.FusedLocationApi.requestLocationUpdates(CompleteActivity.mGoogleApiClient, mLocationRequest, this);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
                ...
                mMap.setOnCameraChangeListener(new GoogleMap.OnCameraChangeListener() {
                    ...
                    public void onCameraChange(CameraPosition cameraPosition) {
                        ...
                        try {
                            ...
                            if (Helper.IsInServiceArea(current_lat,current_lng,"pickup",getActivity())) {
...
//                    mLocationMarkerText.setText("Lat : " + mCenterLatLong.latitude + "," + "Long : " + mCenterLatLong.longitude);
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            Helper.SystemPrintLn(resultData);
            mAddressOutput = resultData.getString(AppUtils.LocationConstants.RESULT_DATA_KEY);
            Helper.SystemPrintLn(mAddressOutput);
        ...
        if(getActivity() != null) {
            ...
            if (requestCode == PLACE_AUTOCOMPLETE_REQUEST_CODE_PICKUP) {
                ...
                if (resultCode == getActivity().RESULT_OK) {
                    ...
                    if(journey_type == 1){
                        if(Helper.IsInServiceArea(current_lat,current_lng,"dropoff",getActivity())) {
                            lower_view.setVisibility(View.VISIBLE);
                            marker_container.setVisibility(View.VISIBLE);
                        } else {
                            lower_view.setVisibility(View.GONE);
    ...
    public void onDestroyView() {
        ...
        database.close();
        CompleteActivity.fragmentManager.beginTransaction().remove(getChildFragmentManager().findFragmentById(R.id.mMapFragment)).commitAllowingStateLoss();
    }
}

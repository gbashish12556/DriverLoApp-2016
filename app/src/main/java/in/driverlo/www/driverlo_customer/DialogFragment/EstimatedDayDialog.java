...
public class EstimatedDayDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        if(getActivity() != null) {
            ...
            Helper.SystemPrintLn("minute_array_length"+String.valueOf(hourValues.length));
            ...
            next_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Helper.SystemPrintLn("Booking Hour"+String.valueOf(booking_hour));
                    Helper.putPreference(getActivity(), Constants.Keys.BOOKING_DAY, String.valueOf(booking_day));
